 ...
 *    gcc -g false-sharing-with-report.c -pthread -lnuma -o false_sharing
 *    gcc -g false-sharing-with-report.c -pthread -lnuma -DNO_FALSE_SHARING -o no_false_sharing
 *
 ...
 *
 * The usage is: 
 *     ./false_sharing <number of threads per node>
 *     ./no_false_sharing <number of threads per node>
 *
