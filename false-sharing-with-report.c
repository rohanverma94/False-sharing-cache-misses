 ...
 *    gcc -g false-sharing-with-report.c -pthread -lnuma -o false_sharing.exe
 *    gcc -g false-sharing-with-report.c -pthread -lnuma -DNO_FALSE_SHARING -o no_false_sharing.exe
 *
